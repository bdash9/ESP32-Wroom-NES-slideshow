 ...
 *
 * Video on cutting the case: https://www.youtube.com/watch?v=3pPOBtM_-Gw
 *
 * Code site: https://github.com/davidxgames/NES-Label-Slider
 *
 * Ben
 * Board: WROOM - Use ESP32 Dev Module
 * Put .png files in / on SD card
...
void PNGDraw(PNGDRAW *pDraw)
{
  ...
  //gfx->draw16bitRGBBitmapWithTranColor(xOffset, yOffset + pDraw->y, usPixels, usMask, pDraw->iWidth, 1);
}
...
void setup() 
{
  ...
  else
  {
    ...
    gfx->setCursor(xCursor + 160, yCursor);
    gfx->print(countPng);
  ...
  xTaskCreatePinnedToCore(taskButtonsAction, "taskButtonsAction", 16384, NULL, 1, NULL, 1);
}
